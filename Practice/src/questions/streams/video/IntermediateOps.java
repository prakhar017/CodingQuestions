...
public class IntermediateOps {
    public static void main(String[] args) {
        ...
        List<List<String>> listOfNamesList = Arrays.asList(
                Arrays.asList("Prakhar", "Anupam"),
                Arrays.asList("Smriti", "Kartik")
        );

        System.out.println(listOfNamesList.stream().flatMap(l ->l.stream()).map(String :: toUpperCase).toList());
        ...
        System.out.println(sentenceList.stream()
